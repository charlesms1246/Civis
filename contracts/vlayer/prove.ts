...
import verifierSpec from "../out/CivisProofVerifier.sol/CivisProofVerifier";

// Select prover spec based on PROVER_TYPE env var (default: wikipedia)
const proverType = process.env.PROVER_TYPE ?? "wikipedia";
const proverSpec =
  proverType === "redcross"
    ? redCrossProverSpec
    : proverType === "msf"
